...
Tags: html, parser, simple, awesome, quick, wordpress
...
1. HTML Parser Plugin's tab position in the sidebar of admin panel.
2. HTML Parser Plugin's Page.
3. HTML Parser with working example.